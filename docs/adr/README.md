...
| [ADR-066](adr-066-phase23-controller-reconcile-emission.md) | Phase 23 Controller Emission Sub-Slice 43.3.5 — controller_job_state_total via reconcile boundary | Proposed | — |
