...
| 26.F3 | `818ef64` | feat(observability): add module-local control-plane slog JSON logger foundation | (Phase 7 Slice 26 follow-up F3) |
...
| 26.F4 | `2d9debe` | feat(observability): register apiserver Prometheus descriptors and bind /metrics | (Phase 7 Slice 26 follow-up F4) |
| 26.F4 | `7e463bb` | feat(observability): register scheduler Prometheus descriptors and bind /metrics | (Phase 7 Slice 26 follow-up F4) |
| 26.F4 | `abf48c9` | feat(observability): register connection-test-executor Prometheus descriptors | (Phase 7 Slice 26 follow-up F4) |
| 26.F4 | `5e216db` | feat(observability): register auth descriptor package (admin CLI stays one-shot) | (Phase 7 Slice 26 follow-up F4) |
| 26.F4 | `4336d4e` | feat(observability): register console Prometheus descriptors and bind /metrics | (Phase 7 Slice 26 follow-up F4) |
