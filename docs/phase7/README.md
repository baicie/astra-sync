...
Slice 26 follow-up slices F1–F10 have completed the SLF4J/slog,
...
batch, checkpoint, spill-byte, and record-count observations, and Connection
Test Executor outcomes now provide live samples; other control-plane business
