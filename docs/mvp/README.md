...
Slice 04 is verified on `mvp/04-jdbc-vertical-slice`; Slice 05 is verified on
`mvp/05-phase0-hardening` and Phase 0 is complete for the documented single-process scope.
...
| 05 | `mvp/05-phase0-hardening` | accepted 04 | Metrics output, cancellation/resource tests, examples, acceptance and release evidence | Complete |
